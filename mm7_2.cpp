  ...
  if ( a2 == 272 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          ...
          if ( v9 )
          {
            ...
            v10 = SetDlgItemTextA;
            SetDlgItemTextA(hDlg, 1010, "Wloz CD-ROM numer 2 Might and MagicЃ VII.");
            v11 = "Odwolaj";
          }
          else
          {
            ...
            v10 = SetDlgItemTextA;
            SetDlgItemTextA(hDlg, 1010, "Inserire il secondo CD di Might and MagicЃ VII.");
            v11 = "Annulla";
          }
        }
        else
        {
          ...
          v10 = SetDlgItemTextA;
          SetDlgItemTextA(hDlg, 1010, "Insйrez Might & MagicЃ VII CD 2.");
          v11 = "Supprimer";
        }
      }
      else
      {
        ...
        v10 = SetDlgItemTextA;
        SetDlgItemTextA(hDlg, 1010, "Por favor, inserte disco 2 de Might & MagicЃ VII.");
        v11 = "Cancelar";
      }
    }
    else
    {
      ...
      v10 = SetDlgItemTextA;
      SetDlgItemTextA(hDlg, 1010, "Bitte CD 2 von Might and MagicЃ VII einlegen.");
      v11 = "Abbrechen";
    }
    v10(hDlg, 2, v11);
    return 0;
...
bool MM_Main(const wchar_t *pCmdLine)
{
  ...
  char test[1024];
  sprintfex(test, "^Pi[%s]: знахар^R[ь;ка;]", "«олтан");
